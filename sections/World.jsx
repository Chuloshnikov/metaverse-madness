    ...
    >
      ...
      >
        ...
        <div className="absolute top-1/2 left-[45%] w-[70px] h-[70px] p-[6px] rounded-full bg-[#5D6680]">
          ...
          <div className='bg-[#5D6680] bottom-[-10%]'/>
        </div>

        <div className="absolute top-10 right-40 w-[217px] h-[167px] p-[6px] rounded-3xl bg-[#5D6680]">
        ...
        <div className="absolute bottom-60 left-[15%] w-[217px] h-[167px] p-[6px] rounded-3xl bg-[#5D6680]">
        <img src="MaskGroup.png" alt="MaskGroup" className="w-full h-full" />
          <div>
            <div className='absolute left-[10%] bottom-[30%] flex items-center'>
              <img className='z-10' src='icon1.png' src='icon1.png'/>
              <img className='absolute left-[8%]' src='icon2.png'/>
              <img src='icon3.png'/>
              <p className='text-[12px] text-white ml-[5px]'>+256 has joined</p>
            </div>
